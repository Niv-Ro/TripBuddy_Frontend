    ...
    return (
        <>
            <div className="card post-card shadow-sm mb-4 mx-auto">
                ...
                {currentMedia && <div className="media-container" onClick={() => setFullscreenMedia(currentMedia)}>
            ...
            {fullscreenMedia && ( <div className="fullscreen-viewer" onClick={() => setFullscreenMedia(null)}>...</div> )}
